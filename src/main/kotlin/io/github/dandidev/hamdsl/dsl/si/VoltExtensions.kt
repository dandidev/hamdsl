...
val Number.TV get() = Volt(toDouble() * SI.TERA)
val Number.teraVolt get() = Volt(toDouble() * SI.TERA)
val Number.GV get() = Volt(toDouble() * SI.GIGA)
val Number.gigaVolt get() = Volt(toDouble() * SI.GIGA)
@get:JvmName("getShortFormatMegaVolt")
...
@get:JvmName("getShortFormatMilliVolt")
...
val Number.pV get() = Volt(toDouble() * SI.PICO)
val Number.picoVolt get() = Volt(toDouble() * SI.PICO)
val Number.fV get() = Volt(toDouble() * SI.FEMTO)
val Number.femtoVolt get() = Volt(toDouble() * SI.FEMTO)